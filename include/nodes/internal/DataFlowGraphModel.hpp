...
public:
  ...
  std::unordered_set<std::pair<NodeId, PortIndex>> connectedNodes(NodeId nodeId, PortType  portType, PortIndex portIndex) const override;
...
private:
    ...
    std::unordered_map<ConnectivityKey, std::unordered_set<std::pair<NodeId, PortIndex>>> _connectivity;
